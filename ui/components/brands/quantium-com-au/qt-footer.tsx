...
/**
 * Quantium site footer.
 * Black background, white logo, three link columns, legal links, social icons.
 */
export function QtFooter() {
  return (
    <footer
    ...
    >
      <div className="mx-auto max-w-[1280px] px-[100px] py-16">
        {/* Logo */}
        <div className="mb-12">
          <QtLogo variant="light" height={24} href={undefined} />
        </div>
